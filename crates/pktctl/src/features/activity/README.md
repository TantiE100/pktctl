...
- Password-protected activities only answer IPC calls after
  `ActivityFile.confirmPassword`; `password_confirmed` tells whether that is
  needed. `call_ipc` reaches it.

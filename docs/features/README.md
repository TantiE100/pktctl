...
| Workspace | `save_network`, `open_network`, `new_network`, `screenshot`, `add_note`, `list_notes`, `remove_note`, `draw`, `list_drawings`, `remove_drawing` | [features/workspace](../../crates/pktctl/src/features/workspace/README.md) |

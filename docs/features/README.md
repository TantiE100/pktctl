...
| Activity | `activity_status`, `activity_instructions`, `check_activity`, `reset_activity`, `network_description` | [features/activity](../../crates/pktctl/src/features/activity/README.md) |
